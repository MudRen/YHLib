...
public mixed accept_ask(object me, object who, string topic)
{
            ...
            topic == "锻炼")
        {
                ...
                {
                        message_vision(CYN "$N" CYN "叹了一口气，看了看$n"
                                       CYN "道：你的武功基础还不太好，还是"
                                       "再好好锻炼吧。\n" NOR, me, who);
                        return 1;
                }
...
int ask_quest(object me, object who)
{
        ...
        } else
        {
                ...
                {
                        message_vision(CYN "$N" CYN "看了看$n" CYN "，叹气道：你在"
