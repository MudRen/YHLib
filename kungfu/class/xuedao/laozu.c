...
void attempt_apprentice(object ob)
{
        ...
        {
                command("say 我平身最看不惯的就是阉人，再不滚开我杀了你！\n");
                return;
        }
        ...
        {
                command("say 虽说咋们平时烧杀抢掠，但总归也算是佛门弟子。\n");
