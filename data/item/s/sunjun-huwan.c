// ITEM Made by player(Ëï¾ı:sunjun) /data/item/s/sunjun-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Sep 28 16:37:45 2002
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[33m»¤Íó[2;37;0m", ({ "huwan" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºËï¾ı(sunjun)
");
	set("value", 2000000);
	set("point", 37);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸[2;37;0m[33m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[2;37;0m[33m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
