// ITEM Made by player(ÔÂÒşÎŞ:shadow) /data/item/s/shadow-wrist.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Dec 18 18:20:24 2002
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36mÔÂÖ®ÑıÃ¢[2;37;0m", ({ "wrist" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºÔÂÒşÎŞ(shadow)
");
	set("value", 2000000);
	set("point", 39);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸[1;36mÔÂÖ®ÑıÃ¢[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[1;36mÔÂÖ®ÑıÃ¢[2;37;0m[33m¡£[2;37;0m\n");
