// ITEM Made by player(ÄÉÀ¼:mong) /data/item/m/mong-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Sep 24 07:11:10 2002
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m»¤Íó[2;37;0m", ({ "huwan" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
ÕâÊÇÒ»¼şÌìÇàÉ«[1;36m»¤Íó[2;37;0m£¬ÈáÈíµÄ±íÃæÉä³öÒ«ÑÛµÄ¹âÔó¡£ÕâÊÇ´«ËµÖĞµÄÖÁ±¦£º[1;36m»¤Íó[2;37;0m¡£[2;37;0m
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºÄÉÀ¼(mong)
");
	set("value", 2000000);
	set("point", 40);
	set("material", "stone");
	set("wear_msg", "$NÎûÎûÒ»Ğ¦£¬´÷ÉÏ[1;36m»¤Íó[2;37;0m¡£[2;37;0m\n");
	set("remove_msg", "$NÎûÎûÒ»Ğ¦£¬ÍÑÏÂ[1;36m»¤Íó[2;37;0m¡£[2;37;0m\n");
