// ITEM Made by player(½­ºşÊõÊ¿:rufeng) /data/item/r/rufeng-mujian.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Oct  1 22:29:16 2002
#include <ansi.h>
#include <weapon.h>
