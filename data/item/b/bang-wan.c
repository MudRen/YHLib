// ITEM Made by player(µ¶°Ô:bang) /data/item/b/bang-wan.c
...
void create()
{
	set_name("[1;32m¾«ÁéÓñïí[2;37;0m", ({ "wan" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºµ¶°Ô(bang)
");
	set("value", 2000000);
	set("point", 33);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸[1;32m¾«ÁéÓñïí[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[1;32m¾«ÁéÓñïí[2;37;0m[33m¡£[2;37;0m\n");
