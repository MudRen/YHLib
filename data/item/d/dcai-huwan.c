// ITEM Made by player(¶Î³¾°£:dcai) /data/item/d/dcai-huwan.c
...
void create()
{
	set_name("ä°Íå[2;37;0m", ({ "huwan" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£º¶Î³¾°£(dcai)
");
	set("value", 2000000);
	set("point", 37);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸ä°Íå[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁËä°Íå[2;37;0m[33m¡£[2;37;0m\n");
