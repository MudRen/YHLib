// ITEM Made by player(¶Î¾ÉÑó:wudanji) /data/item/w/wudanji-sword.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Fri Oct 18 09:07:19 2002
#include <ansi.h>
#include <weapon.h>
...
½£±úÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£º¶Î¾ÉÑó(wudanji)
");
	set("value", 2000000);
	set("point", 123);
	set("material", "stone");
