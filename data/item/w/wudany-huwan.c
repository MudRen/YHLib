// ITEM Made by player(ĞéÄ½:wudany) /data/item/w/wudany-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Mar 30 10:13:32 2003
#include <ansi.h>
#include <armor.h>
...
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºĞéÄ½(wudany)
");
	set("value", 2000000);
	set("point", 33);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸[1;36m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[1;36m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
