// ITEM Made by player(ºúĞĞ:qiangren) /data/item/q/qiangren-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Feb 17 22:00:57 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;32mÁé»êÍó[2;37;0m", ({ "huwan" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ººúĞĞ(qiangren)
");
	set("value", 2000000);
	set("point", 47);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸[1;32mÁé»êÍó[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[1;32mÁé»êÍó[2;37;0m[33m¡£[2;37;0m\n");
