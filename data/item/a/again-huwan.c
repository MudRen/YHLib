// ITEM Made by player(ĞÇ»ğ:again) /data/item/a/again-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jul  9 22:24:31 2002
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;32m»¤Íó[2;37;0m", ({ "huwan" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºĞÇ»ğ(again)
");
	set("value", 2000000);
	set("point", 32);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸[1;32m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[1;32m»¤Íó[2;37;0m[33m¡£[2;37;0m\n");
