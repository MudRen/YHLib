// ITEM Made by player(Ãç¶ù:lingling) /data/item/l/lingling-pai.c
...
void create()
{
	set_name("[1;32m²ÔÓ¬ÅÄ[2;37;0m", ({ "pai" }));
	set_weight(2250);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[37m¾«Ìú[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
[1;32mÒ»Ö»ÌØ´óºÅµÄ[1;31m²ÔÓ¬[1;32mÅÄ[2;37;0m
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºÃç¶ù(lingling)
");
	set("value", 800000);
	set("point", 7);
	set("material", "iron");
	set("wear_msg", "[1;36m½£ÉñÒ»Ğ¦[1;32mË³ÊÖ³é³öÒ»°ÑÌØ´óºÅµÄ[1;31m²ÔÓ¬[1;32mÅÄ[2;37;0m\n");
	set("remove_msg", "[1;36m½£ÉñÒ»Ğ¦[1;32mË³ÊÖ²ØÆğÒ»°ÑÌØ´óºÅµÄ[1;31m²ÔÓ¬[1;32mÅÄ[2;37;0m\n");
