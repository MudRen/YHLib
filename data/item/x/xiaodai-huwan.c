// ITEM Made by player(Ğ¡´ô:xiaodai) /data/item/x/xiaodai-huwan.c
...
void create()
{
	set_name("[1;33m¹ıÑÛÔÆÑÌ[2;37;0m", ({ "huwan" }));
	set_weight(600);
	set("item_make", 1);
	set("unit", "¶Ô");
	set("long", "ÕâÊÇÓÉ[2;37;0m[1;31mÑÖÂŞ³ñ[2;37;0mÁ¶ÖÆ¶ø³ÉµÄÒ»¶Ô»¤Íó¡£
»¤ÍóÔµÉÏ¿Ì×ÅÒ»ĞĞĞ¡×Ö£ºĞ¡´ô(xiaodai)
");
	set("value", 2000000);
	set("point", 75);
	set("material", "stone");
	set("wear_msg", "[33m$N[33m×°±¸[1;33m¹ıÑÛÔÆÑÌ[2;37;0m[33m¡£[2;37;0m\n");
	set("remove_msg", "[33m$N[33mÍÑÏÂÁË[1;33m¹ıÑÛÔÆÑÌ[2;37;0m[33m¡£[2;37;0m\n");
